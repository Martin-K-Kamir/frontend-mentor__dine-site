...
export default function Hero(props) {
    return (
        <header className="[ hero ] [ stacked ] [ fg-neutral-1 ]" data-extrinsic-sizing="true">
            ...
            />
            <div className="[ wrapper flow ] [ space-6 items-justify-center//below-lg direction-row//above-lg ]">
                <div className=" [ hero__container ] [ flow ] [ items-justify-center//below-lg align-center//below-lg ]">
